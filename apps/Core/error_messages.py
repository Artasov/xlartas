...
CONFIRMATION_CODE_SENT_TOO_OFTEN = 'Подождите перед отправкой нового кода подтверждения.'
...
CANNOT_CALC_PRICE = 'Не удалось посчитать цену.'
BALANCE_TO_SMALL = 'Недостаточно средств на балансе. Пополните баланс на {} ₽'
PROMOCODE_NOT_FOUND = 'Такой промокод не найден'