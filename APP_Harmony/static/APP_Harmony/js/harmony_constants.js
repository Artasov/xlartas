const cadences = {
    "AuthenticCadence": ["I", "IV", "V", "I"],
    "PlagalCadence": ["I", "IV", "I"],
    "DeceptiveCadence": ["I", "IV", "V", "VI"],
    "HalfCadence": ["I", "IV", "V"],
    "AmenCadence": ["IV", "I"],
    "PhrygianHalfCadence": ["IV", "bII", "I"],
    "BackdoorCadence": ["I", "IV", "bVII", "I"],
};
const scales = {
    'C': {
        'I': ['C', 'E', 'G'],
...
trainerPresets = {
    'Major': {
        'C Major 1-2-3-4': {
            ...
            'enableKeys': ['C', 'D', 'E', 'F'],
            'countQuestions': 20,
            'cadenceProgression': cadences['AuthenticCadence'],
    ...
    'Chromaticism in a Major': {
        ...
        'C Major Full Chromatic': {
            ...
            'pianoStartKey': 'C',
            'enableKeys': ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B', 'C'],
            'countQuestions': 20,
            'cadenceProgression': cadences['AuthenticCadence'],
            'playCadenceEveryNQuestion': 1,
            'hiddenKeyOctave': 5,
