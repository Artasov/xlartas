...
#                              order_type: SoftwareSubscriptionOrder.SoftwareOrderType,
...
#                              expired_minutes: int = 10, customer: dict = None,
#                              currency: str = 'RUB', custom_fields: dict = None,
#                              SECRET_KEY: str = os.getenv('QIWI_SECRET_KEY'), ) -> SoftwareSubscriptionOrder:
...
#         raise BadRequest
#     order_ = SoftwareSubscriptionOrder.objects.create(user_id=user_id,
#                                           amountRub=amount,
#                                           promo_id=promo_id,
