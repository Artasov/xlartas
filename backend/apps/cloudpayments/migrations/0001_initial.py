    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Created', 'Created'), ('Authorized', 'Authorized'), ('Completed', 'Completed'), ('Declined', 'Declined'), ('Refunded', 'Refunded')], db_index=True, max_length=20, verbose_name='Status')),
            ],
            options={
