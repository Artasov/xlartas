    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('threshold', models.DecimalField(decimal_places=2, help_text='Суммарная сумма донатов, начиная с которой эта привилегия доступна', max_digits=10, verbose_name='Donation threshold')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='donate_orders', to='xlmine.donateproduct', verbose_name='Donate product')),
            ],
            options={
