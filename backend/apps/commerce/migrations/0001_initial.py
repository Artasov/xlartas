    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_system', models.CharField(choices=[('tbank', 'TBank'), ('tbank_installment', 'Tinkoff (Installment)'), ('stripe', 'Stripe'), ('shopozz', 'Shopozz'), ('prodamus', 'Prodamus')], db_index=True, max_length=50, verbose_name='Payment System')),
