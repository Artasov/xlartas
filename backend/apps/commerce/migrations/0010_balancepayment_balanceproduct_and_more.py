...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='payment_system',
            field=models.CharField(choices=[('handmade', 'HandMade'), ('tbank', 'TBank'), ('tbank_installment', 'Tinkoff (Installment)'), ('cloud_payment', 'CloudPayments'), ('freekassa', 'FreeKassa'), ('balance', 'Balance')], db_index=True, max_length=50, verbose_name='Payment System'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balance_orders', to='commerce.balanceproduct', verbose_name='Product')),
            ],
            options={
