...
export const lightTheme = createTheme({
    ...
    typography: {
        ...
        h3: {
            color: 'rgba(0,0,0,.8)', // Цвет для заголовков h3
        },
        h4: {
            color: 'rgba(0,0,0,.8)', // Цвет для заголовков h4
        },
        h5: {
            color: 'rgba(0,0,0,.8)', // Цвет для заголовков h5
        },
        h6: {
            color: 'rgba(0,0,0,.8)', // Цвет для заголовков h6
        },
        body1: {
