...
export const setFolderCached = (id: number | null, data: FolderContent) => {
    cache.folders[id === null ? 'root' : String(id)] = data;
};
export const getAllFilesCached = () => cache.allFiles;
export const setAllFilesCached = (data: any[]) => {
    cache.allFiles = data;
};
export const getFavoriteFilesCached = () => cache.favoriteFiles;
export const setFavoriteFilesCached = (data: any[]) => {
    cache.favoriteFiles = data;
};
