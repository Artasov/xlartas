...
import upIcon from '../../../../static/img/icons/up-arrow.png';
import Tooltip from "../../Tooltip/Tooltip";
import infoIcon from "../../../../static/img/icons/info.png";
...
const InputSelect = ({ name, defaultOptionIndex, label, options, helpText, className }) => {
    ...
    return (
        <div className={`${className} custom-select ${classes.bgPrimary10} ${isOpen ? 'custom-select-opened' : ''}`} ref={dropdownRef}>
            ...
            <div className={`options-container no_scrollbar ${classes.bgPrimary10}`} ref={optionsContainerRef} style={{ height: isOpen ? `${optionsContainerRef.current.scrollHeight}px` : '0px' }}>
                <ul>
