...
import {DISCORD_CLIENT_ID, DOMAIN_URL_ENCODED, GOOGLE_CLIENT_ID} from "./axiosConfig";
    ...
    return (
        <div ref={socialDiv} className={`${className ? className : 'frcc'} mt-3 gap-2`}>
            ...
            <a href={discordOAuth2Url}>
                <IconButton className={'ratio-1-1 '} style={{height: `${pxIconSize}px`}}>
                    <FontAwesomeIcon icon={faDiscord} className={`${iconsClassName} h-100 ratio-1-1`}
