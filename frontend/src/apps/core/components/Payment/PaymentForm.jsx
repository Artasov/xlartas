...
import {TINKOFF_TERMINAL_KEY} from "../auth/axiosConfig";
import {useAuth} from "../auth/useAuth";
import {AuthContext} from "../auth/AuthContext";
import {Message} from "../Message";
import {useStyles} from "../Theme/useStyles"; // Assume this CSS file contains the styles from your <style> block
...
const PaymentForm = ({terminalKey = TINKOFF_TERMINAL_KEY, amount, orderId}) => {
    ...
    return (
        <div className="fccc">
            ...
            <ul className={`fs-5 fw-5 ${classes.textPrimary75} w-100 rounded-3 p-1`}>
